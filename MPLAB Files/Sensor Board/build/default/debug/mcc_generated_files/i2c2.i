...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/i2c2.c" 2
# 51 "mcc_generated_files/i2c2.c"
# 1 "mcc_generated_files/i2c2.h" 1
# 53 "mcc_generated_files/i2c2.h"
...
# 55 "mcc_generated_files/i2c2.h" 2
...
# 56 "mcc_generated_files/i2c2.h" 2
...
# 111 "mcc_generated_files/i2c2.h"
typedef struct
{
    uint16_t address;
...
# 105 "mcc_generated_files/i2c2.c"
typedef struct
{
...
# 129 "mcc_generated_files/i2c2.c"
typedef enum
{
    S_MASTER_IDLE,
    S_MASTER_RESTART,
...
# 178 "mcc_generated_files/i2c2.c"
...
static I2C2_TRANSACTION_REQUEST_BLOCK *p_i2c2_trb_current = ((void*)0);
static volatile I2C_TR_QUEUE_ENTRY *p_i2c2_current = ((void*)0);
...
# 383 "mcc_generated_files/i2c2.c"
...
void I2C2_Stop(I2C2_MESSAGE_STATUS completion_code)
{
    ...
    if (p_i2c2_current->pTrFlag != ((void*)0))
    {
...
__attribute__((inline)) void I2C2_WaitForLastPacketToComplete()
{
